...
# Registra esta classe no catalogo de perdas para ser usada em configuracoes YAML
@manager.LOSSES.add_component
class MixedMSELoss(nn.MSELoss):
    r"""
    **Mean Square Error Loss**
    ...
    def __init__(self, reduction='mean', ignore_index=255):
        # Aceita os mesmos argumentos da MSE nativa para manter compatibilidade
        super().__init__(reduction=reduction)
        # O argumento ignore_index permanece disponivel, mesmo sem uso direto nesta classe
