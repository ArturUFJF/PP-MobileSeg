...
class Dataset(paddle.io.Dataset):
    ...
    def __init__(self,
        ...
        # Define o pipeline de preprocessamento que sera aplicado a cada amostra
        # Organiza a lista de arquivos que serao usados em iteracoes futuras
        self.file_list = list()
        self.mode = mode.lower()
        # Guarda configuracoes fundamentais para validar limites e gerar mascaras
        self.num_classes = num_classes
        self.img_channels = img_channels
        self.ignore_index = ignore_index
        self.edge = edge

        # Garante que os parametros principais estejam coerentes antes de varrer os arquivos
        ...
        # Le o arquivo de indice para montar pares de caminho de imagem e rotulo
        with open(file_path, 'r') as f:
            for line in f:
                ...
                # Guarda caminhos absolutos de imagem e rotulo para indexacao rapida
                self.file_list.append([image_path, label_path])

    def __getitem__(self, idx):
    # Estrutura com todos os dados que serao consumidos pelos transforms e modelo
        data = {}
        data['trans_info'] = []
        ...
        data['gt_fields'] = []
        if self.mode == 'val':
            # Em validacao apenas ajustamos as dimensoes sem gerar campos extras
            ...
            data = self.transforms(data)
            if self.edge:
                # Quando edge esta ativo, gera um contorno binario para tarefas auxiliares
